...
public class ItemModifier
{
    ...
    public string DescribeRoll(float value)
    {
        ...
        string statName = StatAffected switch
        {
            ...
            StatType.AddedPhysicalDamage => "Added Physical Damage to Attacks",
            StatType.AddedFireDamage => "Added Fire Damage to Attacks",
            StatType.AddedColdDamage => "Added Cold Damage to Attacks",
            StatType.AddedLightningDamage => "Added Lightning Damage to Attacks",
            StatType.AddedAcidDamage => "Added Acid Damage to Attacks",
            StatType.AddedDarkDamage => "Added Dark Damage to Attacks",
            StatType.AddedLightDamage => "Added Light Damage to Attacks",
            StatType.AddedArcaneDamage => "Added Arcane Damage to Attacks",
            ...
            StatType.LightRadius => "Light Radius",
